...
x_guess = load_object("nadia_balance_x_ref_4_central_foot.jld2")
u_guess = load_object("nadia_balance_u_ref_4_central_foot.jld2")
...
x_guess[6] = -0.06 # pelvis trans y
x_guess[7] = 1.091 # pelvis trans z
...
function nadia_cost(y::Vector)::Real
    ...
    return 50*norm(x_no_spine - x_guess_no_spine)^2 + 0.5*1e-3*norm(u[1:14])^2 +
            ...
            5000*x_spine_x^2 + 5000*(x_spine_y-0.095)^2
end
